        ...
        <div class="form-card">
            <form action="<%=context%>/offices/edit" method="post">
                ...
                <div class="form-section">
                    ...
                    <input type="number" id="latitude" name="latitude" class="form-input" step="any" value="${office.latitude}" placeholder="위도를 입력하세요 (예: 37.5665)">
                    <p id="latitudeMessage" class="form-message"></p>
                </div>

                <div class="form-section">
                    <label for="longitude" class="form-label">경도</label>
                    <input type="number" id="longitude" name="longitude" class="form-input" step="any" value="${office.longitude}" placeholder="경도를 입력하세요 (예: 126.9780)">
